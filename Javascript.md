...
<details>
  <summary>undefined는 자바스크립트에서 값인가? 만약 undefined === undefined을 하게 된다면 어떤 결과가 나오는가?</summary>
undefined는 자바스크립트에서 ‘정의되지 않음’을 뜻하는 값입니다. 따라서 undefined === undefined을 할 경우 true가 반환되는 것으로 알고 있습니다.
</details>
